...
SET u1.groups = ['동아리', '대학교']


MERGE (u1)-[:is_roommate {edge_id: randomUUID(), memo: '', group: '동아리'}]->(u2)
MERGE (u1)-[:is_roommate {edge_id: randomUUID(), memo: '', group: '동아리'}]->(u3)
MERGE (u1)-[:is_roommate {edge_id: randomUUID(), memo: '', group: '동아리'}]->(u4)
MERGE (u1)-[:is_roommate {edge_id: randomUUID(), memo: '', group: '동아리'}]->(u5)
MERGE (u1)-[:is_roommate {edge_id: randomUUID(), memo: '', group: '동아리'}]->(u6)
MERGE (u1)-[:is_roommate {edge_id: randomUUID(), memo: '', group: '대학교'}]->(u8)
MERGE (u1)-[:is_roommate {edge_id: randomUUID(), memo: '', group: '대학교'}]->(u9)
MERGE (u1)-[:is_roommate {edge_id: randomUUID(), memo: '', group: '대학교'}]->(u11)
MERGE (u1)-[:is_roommate {edge_id: randomUUID(), memo: '', group: '대학교'}]->(u12)
